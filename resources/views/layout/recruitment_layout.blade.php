...
<head>
     ...
     <title>Recrute - Staffing Agency</title>

     <!--=====FAB ICON=======-->
     <link rel="shortcut icon" href="assets/img/logo/title7.png" type="image/x-icon">
...
<body class="body">
        ...
        <div class="preloader">
            <div class="loading-container">
                ...
                <div id="loading-icon"><img src="assets/img/logo/preloader-logo7.png" alt=""></div>
            </div>
        </div>
        <!-- Preloader End -->
            ...
            <div class="row header-bg">
              <div class="col-12">
                <div class="header-elements">
                  <div class="site-logo">
                    <a href="{{route('home')}}">
                      <img src="assets\img\logo\Without_background-02.png" style="height: 70px" alt="">
                    </a>
                  </div>
                  ...
                  <div class="main-menu-ex main-menu-ex1">
                   <ul id="list-example">
                       <li><a class="list-group-item list-group-item-action" href="{{url('/recruitment')}}#about">About</a></li>
                  ...
                  <div class="header2-buttons">
                       <div class="button">
                         <a class="theme-btn15" href="{{route('contact')}}">Contact Us <span><i class="fa-solid fa-arrow-right"></i></span></a>
                       </div>
                  </div>
              ...
              <div class="col-12">
                <div class="mobile-header-elements">
                  <div class="mobile-logo">
                    <a href="{{route('home')}}"><img src="assets/img/logo/header-logo9.png" alt=""></a>
                  </div>
          ...
          <div class="mobile-sidebar d-block d-lg-none">
            ...
            <li class="has-dropdown"><a href="#">Pages</a> 
              ...
              <div class="mobile-button">
                <a class="theme-btn10" href="service.html">Learn More <span><i class="fa-solid fa-arrow-right"></i></span></a>
              </div>
                      ...
                      <div class="col-lg-3 col-md-6 col-12">
                           <div class="single-footer-items">
                                ...
                                <div class="contact-box">
                                  ...
                                  <div class="pera">
                                    <a href="mailto:staffingagency@com">staffingagency@com</a>
                                  </div>
                                </div>
